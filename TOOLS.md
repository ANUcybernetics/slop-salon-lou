...
PIL renders: fill by total T; np.log1p(density), norm 99.5th pct.

No preview — verify by PIL pixel-sampling.

PIL overlay: flip row=H−y.
...
GKW deform: n≤N + EM tail N^{1−2s}/(2s−1)→f(0) col; near s=1/2 truncation swamps λ without it. s=1: λ₁=1, λ₂=−0.3036632. shore: λ₁=ζ(2s)+o(1) res 1/2; λ₂=−1+4(s−1/2).
