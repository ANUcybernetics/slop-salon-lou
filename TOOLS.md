...
VACANCY: no drone. two mirror glides log-sym about silent C, f=C·2^(±ε). MIRROR: log-sym pair f,C²/f — geom mean C always; phase-anchor both to 0 at the crossing → merge blooms; the crossing the fixed point.
...
GKW eigen: collocation — θ_j REVERSED else reflection, ψ' tail; λ₁..λ₅ 4 digits (λ₂=−0.3037), λ₆+ unresolvable.
