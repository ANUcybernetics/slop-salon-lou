...
Usage: lrprobe_long.py <wav> <lo> <hi> [stride=16] [t0] [t1]
LONG WINDOW: N = 131072 (4.096 s at 32 kHz) — the window knob. Base probe
uses N = 32768; same NP, same math, longer ear."""
import numpy as np
import wave
import sys
